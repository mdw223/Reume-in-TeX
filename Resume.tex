...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItem{\textbf{Relavent Coursework:} Software Development, Data Structures, Algorithms, Data Science, Database Mgmt}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Migrate CRM database from SQL to PostgreSQL, improving performance and scalability}
        \resumeItem{Develop and enhance front-end UI features using Angular (HTML, SCSS, TypeScript)}
        \resumeItem{Implement API integrations using C\# to connect front-end and back-end systems}
        \resumeItem{Utilize Azure DevOps for project management, collaboration, and streamlining the application lifecycle}      
        \resumeItem{Contribute to a fast-paced startup environment, adapting to evolving project needs}
    \resumeItemListEnd
